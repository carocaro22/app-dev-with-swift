 ...
 */
if let myComputer = Computer(ram: 0, yearManufactured: 2020){
    print(" \(myComputer.ram) \(myComputer.yearManufactured)")
}
if let yourComputer = Computer(ram: 2, yearManufactured: 2010) {
    print(" \(yourComputer.ram) \(yourComputer.yearManufactured)")
}
