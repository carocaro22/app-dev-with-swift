...
//print("The value of foo is \(foo)")
//Because foo is only visible inside the function
...
let a: String = greeting(greeting: nil, name: "Carlos")
print(a)
print(greeting(greeting: "Sara", name: "Carlos"))
/*:
