 ...
 */
struct Height {
    var highInInches: Double
    var highInCentimeters: Double
    init (highInInches: Double) {
        highInCentimeters = highInInches*2.54
        self.highInInches = highInInches
    }
    init(highInCentimeters: Double) {
        highInInches = highInCentimeters/2.54
        self.highInCentimeters = highInCentimeters
    }
}
/*:
 ...
 */
var someonesHeight = Height(highInInches: 65)
 ...
 */
var myHeight = Height(highInCentimeters: 162)
print(myHeight)
