 ...
 */
let firstName: String = "Med"
let lastName: String = "Mohannazadeh"
...
let newBest = 15125
let congratulations: String = "Congratulations, " + fullName + "! You beat your precious daily high score of " + "\(previousBest) steps by walking \(newBest) stepsyesterday!"
