...
class AthleteTableViewController: UITableViewController {
    ...
    @IBAction func unwindToAthleteFormViewController (unwindSegue: UIStoryboardSegue) {
        if let athleteFormViewController = unwindSegue.source as? AthleteFormViewController {
